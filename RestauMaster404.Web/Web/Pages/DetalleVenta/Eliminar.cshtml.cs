    ...
    public class EliminarModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            try
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "No se pudo obtener el detalle de la venta para su eliminación.");
                    return RedirectToPage("Index");
                }
            }
            catch (Exception)
            {
                ModelState.AddModelError(string.Empty, "Ocurrió un error al cargar el detalle de la venta.");
                return RedirectToPage("Index");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (Id == Guid.Empty)
            {
                ModelState.AddModelError(string.Empty, "ID de detalle venta no válido.");
                await OnGetAsync();
                return Page();
            }
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        ModelState.AddModelError(string.Empty, "Ocurrió un error al eliminar el detalle de la venta.");
                    }
            ...
            {
                ModelState.AddModelError(string.Empty, "Ocurrió un error inesperado al eliminar el detalle de la venta seleccionada.");
                await OnGetAsync();
                return Page();
            }
        }
